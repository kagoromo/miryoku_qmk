...
LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_P),   \
...
KC_PGUP,           KC_HOME,           KC_UP,             KC_END,            KC_BSPC,           KC_INS,            TD(U_TD_U_BASE),   TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
KC_PGDN,           KC_LEFT,           KC_DOWN,           KC_RGHT,           KC_DEL,            KC_CAPS,           KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
